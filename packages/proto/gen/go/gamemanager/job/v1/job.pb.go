...
// 	protoc        (unknown)
// source: gamemanager/job/v1/job.proto
...
func (x *JobEnvelope) Reset() {
	*x = JobEnvelope{}
	mi := &file_gamemanager_job_v1_job_proto_msgTypes[0]
...
func (*JobEnvelope) Descriptor() ([]byte, []int) {
	return file_gamemanager_job_v1_job_proto_rawDescGZIP(), []int{0}
}
...
type CreateServer struct {
	...
	GameVersion   string                 `protobuf:"bytes,2,opt,name=game_version,json=gameVersion,proto3" json:"game_version,omitempty"`        // เวอร์ชันของเกม เช่น "1.21.4"
	AcceptLicense bool                   `protobuf:"varint,3,opt,name=accept_license,json=acceptLicense,proto3" json:"accept_license,omitempty"` // user ต้องติ๊กยอมรับ license ของเกมเองตอนสร้าง ห้าม default true
	Game          string                 `protobuf:"bytes,4,opt,name=game,proto3" json:"game,omitempty"`                                         // game definition id — ว่าง = game default
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateServer) Reset() {
	*x = CreateServer{}
	mi := &file_gamemanager_job_v1_job_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateServer) Descriptor() ([]byte, []int) {
	return file_gamemanager_job_v1_job_proto_rawDescGZIP(), []int{1}
}

func (x *CreateServer) GetVariant() string {
	if x != nil {
		return x.Variant
	}
	return ""
...
func (x *CreateServer) GetGameVersion() string {
	if x != nil {
...
func (x *CreateServer) GetAcceptLicense() bool {
	if x != nil {
...
type StartServer struct {
	...
	HostPort      int32                  `protobuf:"varint,2,opt,name=host_port,json=hostPort,proto3" json:"host_port,omitempty"`         // 0 = ไม่ expose host port (เข้าถึงผ่าน proxy instance ใน network เดียวกัน)
	DockerImage   string                 `protobuf:"bytes,3,opt,name=docker_image,json=dockerImage,proto3" json:"docker_image,omitempty"` // เช่น game-manager/runtime-java:21 — control-plane เลือกจาก definition
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type JobResult struct {
	...
	Detail        string                 `protobuf:"bytes,5,opt,name=detail,proto3" json:"detail,omitempty"` // ข้อมูลเสริม เช่น checksum ของ artifact ที่โหลด
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var File_gamemanager_job_v1_job_proto protoreflect.FileDescriptor
...
const file_gamemanager_job_v1_job_proto_rawDesc = "" +
	...
	"\rcreate_server\x18\n" +
	" \x01(\v2 .gamemanager.job.v1.CreateServerH\x00R\fcreateServer\x12D\n" +
	"\fstart_server\x18\v \x01(\v2\x1f.gamemanager.job.v1.StartServerH\x00R\vstartServer\x12A\n" +
	"\vstop_server\x18\f \x01(\v2\x1e.gamemanager.job.v1.StopServerH\x00R\n" +
	"stopServer\x12A\n" +
	...
	"\x06detail\x18\x05 \x01(\tR\x06detailB?Z=github.com/game-manager/proto/gen/go/gamemanager/job/v1;jobv1b\x06proto3"

var (
	file_gamemanager_job_v1_job_proto_rawDescOnce sync.Once
	file_gamemanager_job_v1_job_proto_rawDescData []byte
)

func file_gamemanager_job_v1_job_proto_rawDescGZIP() []byte {
	file_gamemanager_job_v1_job_proto_rawDescOnce.Do(func() {
		file_gamemanager_job_v1_job_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_gamemanager_job_v1_job_proto_rawDesc), len(file_gamemanager_job_v1_job_proto_rawDesc)))
	})
...
func file_gamemanager_job_v1_job_proto_init() {
	if File_gamemanager_job_v1_job_proto != nil {
		return
	}
	file_gamemanager_job_v1_job_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_gamemanager_job_v1_job_proto_goTypes,
		DependencyIndexes: file_gamemanager_job_v1_job_proto_depIdxs,
		MessageInfos:      file_gamemanager_job_v1_job_proto_msgTypes,
	}.Build()
	File_gamemanager_job_v1_job_proto = out.File
	file_gamemanager_job_v1_job_proto_goTypes = nil
	file_gamemanager_job_v1_job_proto_depIdxs = nil
}
