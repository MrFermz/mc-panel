...
// 	protoc        (unknown)
// source: gamemanager/agent/v1/agent.proto
...
func (ServerState) Descriptor() protoreflect.EnumDescriptor {
	return file_gamemanager_agent_v1_agent_proto_enumTypes[0].Descriptor()
}

func (ServerState) Type() protoreflect.EnumType {
	return &file_gamemanager_agent_v1_agent_proto_enumTypes[0]
}
...
func (ServerState) EnumDescriptor() ([]byte, []int) {
	return file_gamemanager_agent_v1_agent_proto_rawDescGZIP(), []int{0}
}
...
func (x *AgentMessage) Reset() {
	*x = AgentMessage{}
	mi := &file_gamemanager_agent_v1_agent_proto_msgTypes[0]
...
func (x *Hello) Reset() {
	*x = Hello{}
	mi := &file_gamemanager_agent_v1_agent_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Hello) Descriptor() ([]byte, []int) {
	return file_gamemanager_agent_v1_agent_proto_rawDescGZIP(), []int{1}
}
...
func (x *Heartbeat) Reset() {
	*x = Heartbeat{}
	mi := &file_gamemanager_agent_v1_agent_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Heartbeat) Descriptor() ([]byte, []int) {
	return file_gamemanager_agent_v1_agent_proto_rawDescGZIP(), []int{2}
}
...
func (x *ConsoleOutput) Reset() {
	*x = ConsoleOutput{}
	mi := &file_gamemanager_agent_v1_agent_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConsoleOutput) Descriptor() ([]byte, []int) {
	return file_gamemanager_agent_v1_agent_proto_rawDescGZIP(), []int{3}
}
...
type ServerStatus struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ServerId      string                 `protobuf:"bytes,1,opt,name=server_id,json=serverId,proto3" json:"server_id,omitempty"`
	State         ServerState            `protobuf:"varint,2,opt,name=state,proto3,enum=gamemanager.agent.v1.ServerState" json:"state,omitempty"`
...
func (x *ServerStatus) Reset() {
	*x = ServerStatus{}
	mi := &file_gamemanager_agent_v1_agent_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ServerStatus) Descriptor() ([]byte, []int) {
	return file_gamemanager_agent_v1_agent_proto_rawDescGZIP(), []int{4}
}
...
type ServerStats struct {
	...
	MaxPlayers    int32    `protobuf:"varint,11,opt,name=max_players,json=maxPlayers,proto3" json:"max_players,omitempty"` // จาก reply ของ roster command — 0 = ยังไม่ได้ resync รอบแรก
	// tick_rate = metric ประจำเกมที่อ่านจาก console (minecraft = TPS)
	// 0 = variant นี้ไม่รองรับ metric ดังกล่าว ไม่ใช่ "ค่าเป็นศูนย์"
	TickRate      float64 `protobuf:"fixed64,12,opt,name=tick_rate,json=tickRate,proto3" json:"tick_rate,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ServerStats) Reset() {
	*x = ServerStats{}
	mi := &file_gamemanager_agent_v1_agent_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ServerStats) Descriptor() ([]byte, []int) {
	return file_gamemanager_agent_v1_agent_proto_rawDescGZIP(), []int{5}
}
...
func (x *ServerStats) GetTickRate() float64 {
	if x != nil {
		return x.TickRate
	}
	return 0
...
func (x *ControlMessage) Reset() {
	*x = ControlMessage{}
	mi := &file_gamemanager_agent_v1_agent_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ControlMessage) Descriptor() ([]byte, []int) {
	return file_gamemanager_agent_v1_agent_proto_rawDescGZIP(), []int{6}
}
...
func (x *FileRequest) Reset() {
	*x = FileRequest{}
	mi := &file_gamemanager_agent_v1_agent_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FileRequest) Descriptor() ([]byte, []int) {
	return file_gamemanager_agent_v1_agent_proto_rawDescGZIP(), []int{7}
}
...
func (x *FileList) Reset() {
	*x = FileList{}
	mi := &file_gamemanager_agent_v1_agent_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FileList) Descriptor() ([]byte, []int) {
	return file_gamemanager_agent_v1_agent_proto_rawDescGZIP(), []int{8}
}
...
func (x *FileRead) Reset() {
	*x = FileRead{}
	mi := &file_gamemanager_agent_v1_agent_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FileRead) Descriptor() ([]byte, []int) {
	return file_gamemanager_agent_v1_agent_proto_rawDescGZIP(), []int{9}
}
...
func (x *FileWrite) Reset() {
	*x = FileWrite{}
	mi := &file_gamemanager_agent_v1_agent_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FileWrite) Descriptor() ([]byte, []int) {
	return file_gamemanager_agent_v1_agent_proto_rawDescGZIP(), []int{10}
}
...
var File_gamemanager_agent_v1_agent_proto protoreflect.FileDescriptor

const file_gamemanager_agent_v1_agent_proto_rawDesc = "" +
	"\n" +
	" gamemanager/agent/v1/agent.proto\x12\x14gamemanager.agent.v1\"\xbb\x03\n" +
	"\fAgentMessage\x123\n" +
	"\x05hello\x18\x01 \x01(\v2\x1b.gamemanager.agent.v1.HelloH\x00R\x05hello\x12?\n" +
	"\theartbeat\x18\x02 \x01(\v2\x1f.gamemanager.agent.v1.HeartbeatH\x00R\theartbeat\x12L\n" +
	"\x0econsole_output\x18\x03 \x01(\v2#.gamemanager.agent.v1.ConsoleOutputH\x00R\rconsoleOutput\x12I\n" +
	"\rserver_status\x18\x04 \x01(\v2\".gamemanager.agent.v1.ServerStatusH\x00R\fserverStatus\x12F\n" +
	"\fserver_stats\x18\x05 \x01(\v2!.gamemanager.agent.v1.ServerStatsH\x00R\vserverStats\x12I\n" +
	"\rfile_response\x18\x06 \x01(\v2\".gamemanager.agent.v1.FileResponseH\x00R\ffileResponseB\t\n" +
	"\apayload\"\x96\x01\n" +
	"\x05Hello\x12#\n" +
	...
	"\x05lines\x18\x02 \x03(\tR\x05lines\"\x81\x01\n" +
	"\fServerStatus\x12\x1b\n" +
	"\tserver_id\x18\x01 \x01(\tR\bserverId\x127\n" +
	"\x05state\x18\x02 \x01(\x0e2!.gamemanager.agent.v1.ServerStateR\x05state\x12\x1b\n" +
	"\texit_code\x18\x03 \x01(\x05R\bexitCode\"\xac\x03\n" +
	...
	"maxPlayers\x12\x1b\n" +
	"\ttick_rate\x18\f \x01(\x01R\btickRate\"\xe9\x01\n" +
	...
	"\x04list\x18\n" +
	" \x01(\v2\x1e.gamemanager.agent.v1.FileListH\x00R\x04list\x124\n" +
	"\x04read\x18\v \x01(\v2\x1e.gamemanager.agent.v1.FileReadH\x00R\x04read\x127\n" +
	...
	"\rmod_time_unix\x18\x04 \x01(\x03R\vmodTimeUnix\"\xd0\x01\n" +
	"\fFileResponse\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess\x12\x14\n" +
	"\x05error\x18\x03 \x01(\tR\x05error\x129\n" +
	"\aentries\x18\x04 \x03(\v2\x1f.gamemanager.agent.v1.FileEntryR\aentries\x12\x18\n" +
	...
	"\x14SERVER_STATE_ERRORED\x10\x052g\n" +
	"\fAgentService\x12W\n" +
	"\aConnect\x12\".gamemanager.agent.v1.AgentMessage\x1a$.gamemanager.agent.v1.ControlMessage(\x010\x01BCZAgithub.com/game-manager/proto/gen/go/gamemanager/agent/v1;agentv1b\x06proto3"

var (
	file_gamemanager_agent_v1_agent_proto_rawDescOnce sync.Once
	file_gamemanager_agent_v1_agent_proto_rawDescData []byte
)

func file_gamemanager_agent_v1_agent_proto_rawDescGZIP() []byte {
	file_gamemanager_agent_v1_agent_proto_rawDescOnce.Do(func() {
		file_gamemanager_agent_v1_agent_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_gamemanager_agent_v1_agent_proto_rawDesc), len(file_gamemanager_agent_v1_agent_proto_rawDesc)))
	})
	return file_gamemanager_agent_v1_agent_proto_rawDescData
}
...
var file_gamemanager_agent_v1_agent_proto_goTypes = []any{
	...
	(*Hello)(nil),          // 2: gamemanager.agent.v1.Hello
	(*Heartbeat)(nil),      // 3: gamemanager.agent.v1.Heartbeat
	(*ConsoleOutput)(nil),  // 4: gamemanager.agent.v1.ConsoleOutput
	(*ServerStatus)(nil),   // 5: gamemanager.agent.v1.ServerStatus
	(*ServerStats)(nil),    // 6: gamemanager.agent.v1.ServerStats
	(*ControlMessage)(nil), // 7: gamemanager.agent.v1.ControlMessage
	(*FileRequest)(nil),    // 8: gamemanager.agent.v1.FileRequest
...
var file_gamemanager_agent_v1_agent_proto_depIdxs = []int32{
	...
	3,  // 1: gamemanager.agent.v1.AgentMessage.heartbeat:type_name -> gamemanager.agent.v1.Heartbeat
...
func file_gamemanager_agent_v1_agent_proto_init() {
	if File_gamemanager_agent_v1_agent_proto != nil {
		return
	}
	file_gamemanager_agent_v1_agent_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_gamemanager_agent_v1_agent_proto_msgTypes[6].OneofWrappers = []any{
		(*ControlMessage_Welcome)(nil),
		(*ControlMessage_ConsoleInput)(nil),
		(*ControlMessage_FileRequest)(nil),
	}
	file_gamemanager_agent_v1_agent_proto_msgTypes[7].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_gamemanager_agent_v1_agent_proto_goTypes,
		DependencyIndexes: file_gamemanager_agent_v1_agent_proto_depIdxs,
		EnumInfos:         file_gamemanager_agent_v1_agent_proto_enumTypes,
		MessageInfos:      file_gamemanager_agent_v1_agent_proto_msgTypes,
	}.Build()
	File_gamemanager_agent_v1_agent_proto = out.File
	file_gamemanager_agent_v1_agent_proto_goTypes = nil
	file_gamemanager_agent_v1_agent_proto_depIdxs = nil
}
