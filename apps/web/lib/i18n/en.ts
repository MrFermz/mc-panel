...
export const en = {
  ...
  "users.identifierHint": "Provide an email, a username, or both — at least one is required.",
  "users.identifierRequired": "Enter an email or a username.",
  "users.emailExists": "That email is already registered.",
